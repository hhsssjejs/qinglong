...
void MJ_Interface::dataBusWrite(DataBus &busIn) {
    ...
    busIn.fR[1]=f3d[1][1];
    busIn.fR[2]=f3d[2][1];
    busIn.Mujoco_basePos[0]=basePos[0];
    busIn.Mujoco_basePos[1]=basePos[1];
    busIn.Mujoco_basePos[2]=basePos[2];
    busIn.Mujoco_baseLinVel[0]=baseLinVel[0];
    busIn.Mujoco_baseLinVel[1]=baseLinVel[1];
    busIn.Mujoco_baseLinVel[2]=baseLinVel[2];
